...
\lstinputlisting[linerange={9-10,23-36}]{impl/syntax.ml}

\lstinputlisting[linerange={58-67}]{impl/syntax.ml}
...
\lstinputlisting[linerange={26-50}]{impl/step.ml}

Finally, we can implement reductions and multi-step reductions:

\lstinputlisting[linerange={53-68}]{impl/step.ml}
...
\lstinputlisting[linerange={9-34}]{impl/eval.ml}

We finish by performing something akin to a fold on the syntax tree.

\lstinputlisting[linerange={36-46}]{impl/eval.ml}
