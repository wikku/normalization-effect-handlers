...
\begin{abstract}
	...
	We demonstrate a novel proof of termination of evaluation for
	a $λ$-calculus with deep effect handlers and a type-and-effect system that
	disallows recursive effects.
	The key idea is the construction of logical relations for the language
...
Relations on expressions and control-stuck terms.}
\label{logrel}
\end{figure}
