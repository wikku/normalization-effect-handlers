...
In this work we define logical relations
...
\end{mathpar}
\caption{Contraction ($↦$) and reduction ($→$).} % TODO "Contraction"???
\label{reduction}
\end{figure}
...
\begin{align*}
	...
	⟦\kE⟧ = ⟦\kR⟧ &= \mathcal{P}(\textrm{CExp}×ℕ×\mathsf{Type})
\end{align*}
...
\end{align*}
\caption{Interpretation of types and effects.
...
i.e.\ as the least solution to the system of equations (we will elaborate on that soon).
