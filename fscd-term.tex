...
so our normalization result is not just a peculiarity of the calculus chosen. % TODO nonsense
...
As it is even terser than the previous one, we cannot give any comment. % TODO nonsense
