...
We call them the spaces of \textit{semantic types} and \textit{semantic effects}.
\begin{align*}
...
Using structural induction we simultaneously define the interpretations of types and effects, as well as
relations $\E$ on expressions and $\S$ on stuck terms.
...
We define the set $\E⟦τ/ρ⟧_η$ as a solution to the fixed-point equation
$\E⟦τ/ρ⟧_η(X) = X$.
The function $\E⟦τ/ρ⟧_η$ is monotone, so by the Knaster-Tarski theorem
it has a least fixed point.
From its characterization as the intersection of all $\E⟦τ/ρ⟧_η$-closed sets,
we immediately obtain the induction principle.
...
\begin{lemma}[Induction principle]\label{induction}
	Assume that $P(e)$ is implied by
	$e$ evaluating to a value in $⟦τ⟧_η$
	or reducing to some $K[\Do v]$ such that there exist $(v,n,μ)∈⟦ρ⟧_η$ such that $n\Free(K)$
	and $P(K[u])$ holds for all $u∈μ$.
...
Take any $η∈⟦Δ⟧$.
Let $Y = \{e │ \Lift{e} ∈ \E⟦τ/ε·ρ⟧_η\}$.
We will show $\E⟦τ/ρ⟧_η ⊆ Y$ by showing $\E⟦τ/ρ⟧_η(Y) ⊆ Y$.
Take any $e∈\E⟦τ/ρ⟧_η(Y)$.

If $e →^* K[\Do v] ∈ \S⟦τ/ρ⟧_η(Y)$, then
we have $(v, n, μ) ∈ ⟦ρ⟧_η$ such that $n\Free(K)$ and
$∀u∈μ.\, K[u] ∈ Y$
We have $(v, n+1, μ) ∈ ⟦ε·ρ⟧_η$, $n+1\Free(\Lift{K})$,
and $∀u∈μ.\, \Lift{K[u]} ∈ \E⟦τ/ε·ρ⟧_η$.
So $\Lift{K[\Do v]} ∈ \S⟦τ/ε·ρ⟧_η$ and $\Lift{e} ∈ \E⟦τ/ε·ρ⟧_η$
by antireduction.
...
\begin{lemma}[Application to value compatibility]
\end{lemma}
\begin{proof}
Fix any well-formed $Δ$ and $τ_1 →_ρ τ_2$.
Take any $η∈⟦Δ⟧$ and $(λx.\,e) ∈ ⟦τ_1 →_ρ τ_2/ρ⟧_η$.
Let $Y = \{ e │ (λx.\,e)\;e ∈ \E⟦τ_2/ρ⟧_η\}$.
We will show $\E⟦τ_1/ρ⟧_η ⊆ Y$ by showing $\E⟦τ_1/ρ⟧_η(Y) ⊆ Y$.
Take any $e_2 ∈ \E⟦τ_1/ρ⟧_η(Y)$.

If $e_2 →^* K[\Do v] ∈ \S⟦τ_1/ρ⟧_η(Y)$, then
there exists $(v,n,μ)∈⟦ρ⟧_η$ such that $n\Free(K)$ and for all $u∈μ$
we have $K[u]∈Y$.
Since $n\Free((λx.\,e)\;e)$ and for all $u∈μ$ we have $((λx.\,e)\;K[u] ∈ \E⟦τ_2/ρ⟧_η$,
$(λx.\,e)\;K[\Do v] ∈ \S⟦τ_2/ρ⟧_η$ and by antireduction $(λx.\,e)\;e_2 ∈ \E⟦τ_2/ρ⟧_η$.

If $e_2 →^* v ∈ ⟦τ_1⟧_η$, then
$(λx.\,e)\;e_2 →^* e\subst{v}{x} ∈ \E⟦τ_2/ρ⟧_η$,
so $(λx.\,e)\;e_2 ∈ \E⟦τ_2/ρ⟧_η$ by antireduction.
\end{proof}
...
Let $Y = \{e_1 │ e_1\;e_2 ∈ \E⟦τ_2/ρ⟧_η\}$.
We will show $\E⟦τ_1 →_ρ τ_2/ρ⟧⊆Y$ by showing $\E⟦τ_1 →_ρ τ_2/ρ⟧_η(Y) ⊆ Y$.
Take any $e_1 ∈ \E⟦τ_1 →_ρ τ_2/ρ⟧_η(Y)$.

If $e_1 →^* K_1[\Do v] ∈ \S⟦τ_1 →_ρ τ_2/ρ⟧_η(Y)$, then
there exists $(v,n,μ)∈⟦ρ⟧_η$ such that $n\Free(K_1)$ and for all $u∈μ$
we have $K_1[u] ∈ Y$.
Since $n\Free(K_1\;e_2)$ and for all $u∈μ$ we have $K_1[u]\;e_2 ∈ \E⟦τ_2/ρ⟧_η$,
$K_1[\Do v]\;e_2 ∈ \S⟦τ_2/ρ⟧_η$ and by antireduction $e_1\;e_2 ∈ \E⟦τ_2/ρ⟧_η$.

Now assume $e_1 →^* (λx.\,e) ∈ ⟦τ_1 →_ρ τ_2/ρ⟧_η$.
By the previous lemma $(λx.\,e)\;e_2 ∈ \E⟦τ_2/ρ⟧_η$,
so by antireduction $e_1\;e_2 ∈ \E⟦τ_2/ρ⟧_η$.
\end{proof}
...
Take any $η∈⟦Δ⟧$.
Let $Y = \{e │ \Handle e\,h ∈ \E⟦τ_r/ρ⟧_η\}$.
We will show $\E⟦τ/(Δ'.\,τ_1 \Rightarrow τ_2) · ρ⟧_η ⊆ Y$
by showing $\E⟦τ/(Δ'.\,τ_1 \Rightarrow τ_2) · ρ⟧_η(Y) ⊆ Y$.
Note that only $τ_1$ and $τ_2$ require $Δ'$ to be in context.
Take $e ∈ \E⟦τ/(Δ'.\,τ_1 \Rightarrow τ_2) · ρ⟧_η(Y)$.

If $e →^* v ∈ ⟦τ⟧_η$,
then $\Handle e\,h →^* e_r\subst{v}{x} ∈ \E⟦τ_r/ρ⟧_η$,
so the claim follows by antireduction.

If $e →^* K[\Do v] ∈ \S⟦τ/(Δ'.\,τ_0 \Rightarrow τ_2) · ρ⟧_η(Y)$,
then we have $(v,n,μ) ∈ ⟦(Δ'.\,τ_1 \Rightarrow τ_2) · ρ⟧_η$
such that $n\Free(K)$ and $∀u∈μ.\,K[u]∈Y$.
...
Which holds, since $K[u] ∈ Y$.
Therefore, $e_h\subst{v}{x}\subst{v_c}{r} ∈ \E⟦τ_r/ρ⟧_η$ and the claim follows
by antireduction.
...
\end{lemma}
\begin{proof}
By induction on subtyping rules it can be shown that
if $σ_1 <: σ_2$, then $⟦σ_1⟧_η ⊆ ⟦σ_2⟧_η$ (for $σ_i$ of any kind).

So if $Δ ⊢ τ_1 <: τ_2$, $Δ ⊢ ρ_1 <: ρ_2$ and $Δ; Γ ⊨ e : τ_1╱ρ_1$,
then by \cref{mono}
$Δ; Γ ⊨ e : τ_2╱ρ_2$.
\end{proof}
