...
finitely many times alng the way.
...
Nevertheless, we consider a direct extension to support grouping operations into one effect.
Effects now are sets of distinct operation names together with their types.
$$
	\inferrule
