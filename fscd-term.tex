...
\lstinputlisting[linerange={1-14}]{impl/syntax.ml}

\lstinputlisting[linerange={16-25}]{impl/syntax.ml}
...
\lstinputlisting[linerange={3-24}]{impl/step.ml}

We implement decomposing terms into evaluation contexts and redexes:

\lstinputlisting[linerange={26-51}]{impl/step.ml}

Finally, we can implement reductions and multi-step reductions:

\lstinputlisting[linerange={52-57}]{impl/step.ml}

\lstinputlisting[linerange={59-67}]{impl/step.ml}
