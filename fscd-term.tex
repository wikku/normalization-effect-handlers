...
and an effectful operation with label $l$ would only look at the row for $l$.
...
Nevertheless, we can sketch how we could accomodate grouping operations into one effect natively.
...
We refrain from presenting the details, as the interpretations
...
so our normalization result is not just a peculiarity of the calculus chosen.
