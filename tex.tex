...
but affect the surrounding code in interesting ways.
...
which do not always play well with the rest of the language and aren't easily composed).
...
We can \textit{perform an operation}, just as we can raise an exception in a typical programming language.
...
That's why languages with algebraic effects typically have
...
our relation is unary, we additionally have polymorphic effects, we don't have type lambdas.
